...
public class MemberSignUpController extends StartController {
    @FXML
    ...
    public void signUp(ActionEvent event) throws IOException {
        ...
        if (BTL.DatabaseClasses.SystemDatabase.isValidName(nameField.getText()) &&
                BTL.DatabaseClasses.SystemDatabase.isValidNumber(phoneField.getText()) &&
                BTL.DatabaseClasses.SystemDatabase.isValidEmail(emailField.getText())) {
